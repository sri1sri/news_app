...
class ChannelScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      child: F_ChannelScreen(),
    );
  }
}

class F_ChannelScreen extends StatefulWidget {
  @override
  _F_ChannelScreen createState() => _F_ChannelScreen();
}

class _F_ChannelScreen extends State<F_ChannelScreen> {
